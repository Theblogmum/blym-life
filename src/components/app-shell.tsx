    ...
    groups: [
      ...
      { label: "Store", icon: ShoppingBag, to: "/store" },
      {
        label: "Progress", icon: Trophy, items: [
          ...
          { to: "/schedule", label: "Content Calendar™" },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        label: "Create", icon: Sparkles, items: [
          { to: "/generator", label: "Daily Spark™" },
          { to: "/film-this", label: "Film This™" },
      ...
      },
      {
        label: "Grow", icon: TrendingUp, items: [
          ...
          { to: "/deliverables-builder", label: "Deliverables Builder™" },
          { to: "/usage-rights", label: "Rights Rates™" },
  ...
  return (
    <div className="landing-brand min-h-screen w-full bg-background">
      ...
      <div className="flex w-full">
        {sidebarOpen && (
          <aside className="sticky top-0 hidden h-screen w-60 shrink-0 glass-sidebar lg:block">
            {sidebarInner()}
          </aside>
        )}
        ...
        {mobileOpen && (
          <>
            ...
            <aside className="fixed inset-y-0 left-0 z-50 w-64 glass-sidebar shadow-2xl lg:hidden">
