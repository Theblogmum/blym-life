...
function PriceCard({
  ...
  return (
    <div className={highlighted
      ...
      : "group relative h-full rounded-[1.75rem] bg-[image:var(--gradient-warm)] p-[1.5px] shadow-[var(--shadow-soft)] transition-all duration-300 hover:-translate-y-1.5 hover:scale-[1.015] hover:shadow-[0_24px_60px_-20px_color-mix(in_oklab,var(--primary)_30%,transparent)]"}>
