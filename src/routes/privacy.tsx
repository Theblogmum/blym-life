...
function PrivacyPage() {
  return (
    <article className="mx-auto max-w-3xl px-6 py-12 text-sm leading-relaxed text-foreground">
      ...
      <p className="mt-2">
        Blym is operated by Stephanie Trump, a sole trader based in Guernsey, Channel Islands, trading as "Blym". For privacy matters we are the <strong>data controller</strong> of the personal data described below.
