  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-12 text-sm leading-relaxed text-foreground">
      ...
      <p className="mt-2">
        ...
        Contact: <a className="underline" href="mailto:theblogmum@gmail.com">theblogmum@gmail.com</a>.
      </p>
      ...
      <p className="mt-2">
        To exercise any of these, email <a className="underline" href="mailto:theblogmum@gmail.com">theblogmum@gmail.com</a>.
