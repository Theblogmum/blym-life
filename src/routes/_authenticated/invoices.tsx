...
function Page() {
  ...
  return (
    <div>
      <PageHero icon={Receipt} eyebrow="Creator Pay™" title="Invoices, sent in minutes." description="Build branded invoices, save them, print to PDF and chase what you're owed." variant="warm" />
