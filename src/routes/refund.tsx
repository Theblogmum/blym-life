...
function RefundPage() {
  return (
    <article className="mx-auto max-w-3xl px-6 py-12 text-sm leading-relaxed text-foreground">
      ...
      <p className="mt-2">
        Email us at <a className="underline" href="mailto:info@blym.life">info@blym.life</a> with the email
      ...
      <p className="mt-2">
        Email <a className="underline" href="mailto:info@blym.life">info@blym.life</a> and we'll get back to you.
      </p>
    </article>
  );
}
